  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        <span className="rounded-full bg-secondary/10 px-3 py-1 text-[9px] font-black uppercase tracking-[0.2em] text-secondary">
          {category}
        </span>
      ...
      <h3 className="mb-3 text-xl font-black leading-tight text-title tracking-tight group-hover:text-secondary transition-colors line-clamp-2">
        {title}
      </h3>
