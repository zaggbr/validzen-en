    ...
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="container relative flex flex-col items-center py-20 text-center md:py-36">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <span className="text-4xl font-black tracking-tight text-title md:text-7xl">
        ...
        <motion.p
          ...
          className="mb-4 text-xs font-bold uppercase tracking-[0.4em] text-secondary opacity-80"
        >
        ...
        <motion.h1
          ...
          className="mx-auto mt-4 max-w-2xl text-2xl font-black leading-tight tracking-tight text-title md:text-4xl"
        >
        ...
        >
          ...
          <p className="mt-3 text-xs font-bold uppercase tracking-[0.2em] text-title opacity-60">
        ...
        >
          <Button
            ...
            variant="hero"
            size="lg"
            className="w-full sm:w-auto rounded-full px-10 py-4 text-sm font-black uppercase tracking-widest shadow-xl shadow-secondary/20 transition-all hover:scale-105 active:scale-95"
          >
