const Disclaimer = () => {
  return (
    <div className="rounded-2xl border border-secondary/20 bg-secondary/5 px-6 py-5">
      <p className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em] mb-2">⚠️ Important Notice</p>
      <p className="text-[10px] text-muted-foreground leading-relaxed font-bold opacity-70 uppercase tracking-widest">
