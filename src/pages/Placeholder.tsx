  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold text-title tracking-tight">Expanding Discovery</h1>
        ...
        <Button asChild variant="hero" className="rounded-full px-8 py-7 font-bold uppercase tracking-widest text-[10px] shadow-xl shadow-secondary/20">
          <Link to="/dashboard">
