    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 py-12 md:py-24">
        <div className="container max-w-3xl">
          ...
          >
            <h1 className="mb-10 text-4xl font-black text-title tracking-tight md:text-5xl">Terms of Use</h1>
            ...
            <h2 className="text-2xl font-black">Site Access</h2>
            <p className="text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-black">Restrictions on Use</h2>
            <p className="text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-black">Ownership of Information</h2>
            <p className="text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-black">Hyperlinks</h2>
            <p className="text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-black">Comments & Testimonials</h2>
            <p className="text-lg leading-relaxed">
